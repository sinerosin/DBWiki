...
import com.example.dbwiki.databinding.FragmentTroopersBinding;
...
public class TroopersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTroopersBinding.inflate(inflater, container, false);
            ...
            switch (resource.status) {
                ...
                case SUCCESS:
                    ...
                    for (CharacterResponse.CharacterEntry character : resource.data) {
                        ...
                        if (affiliation != null && affiliation.equalsIgnoreCase("Pride Troopers")) {
