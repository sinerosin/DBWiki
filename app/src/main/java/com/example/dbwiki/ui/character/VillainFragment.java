...
public class VillainFragment extends Fragment {
     ...
     * @return A new instance of fragment VillainFragment.
     */
    public static VillainFragment newInstance(String param1, String param2) {
        VillainFragment fragment = new VillainFragment();
    ...
    private void observarViewModel() {
        MutableLiveData<Resource<List<Charactermodel>>> targetList = viewModel.villainList; // Observamos la lista específica de Villanos
        ...
        targetList.observe(getViewLifecycleOwner(), resource -> {
            ...
            switch (resource.status) {
                case LOADING:
                    // Implementar la lógica de carga si es necesario (el layout no tiene un ProgressBar visible para este caso)
                    break;
